...
class CliView extends View
{
    ...
    public function view(array $arr)
    {
        ...
        echo "=================================================================== \n";
        echo "Было добавлено собак = " .$arr['addedDog']. " не было добавлено = " . $arr['notAddedDog'] ."\n";
        echo "Было добавлено кошек = " .$arr['addedCat']. " не было добавлено = " . $arr['notAddedCat'] ."\n";
        echo "=================================================================== \n";
        echo (int)$arr['newSpaceCat'] . " столько котиков может поместиться в коробку \n";
        echo (int)$arr['newSpaceDog'] . " столько щеночков может поместиться в коробку \n";
        echo "=================================================================== \n";
        if($arr['clear'] == true) {
            echo "Пора убираться!";
